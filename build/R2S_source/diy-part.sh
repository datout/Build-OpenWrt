...
sed -i "/uci commit network/i\uci set network.lan.ipaddr='192.168.10.1'" $ZZZ                       # IPv4 地址(openwrt后台地址)
...
sed -i "/uci commit system/i\uci set system.@system[0].hostname='R2S'" $ZZZ             # 修改主机名称为x86-64-OpenWrt
